...
export function Calendar() {
  ...
  // Get calibration data from context
  const { calibrationData, isLoading, error, refreshCalibrationData } = useCalibration()
  ...
  const handleDateSelect = (date: string) => {
    ...
    .then(data => {
      ...
      // Always refresh calibration data first to ensure both calendar and upcoming deadlines are updated
      refreshCalibrationData().then(() => {
        // Display notification based on response status after data is refreshed
